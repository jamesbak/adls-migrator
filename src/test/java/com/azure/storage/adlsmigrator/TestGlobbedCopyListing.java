...
public class TestGlobbedCopyListing {
  ...
  private static void recordInExpectedValues(String path) throws Exception {
    ...
    expectedValues.put(sourcePath.toString(), AdlsMigratorUtils.getRelativePath(
  ...
  public void testRun() throws Exception {
    ...
    AdlsMigratorOptions options = new AdlsMigratorOptions(Arrays.asList(source), target);
