...
public class TestAdlsMigratorViewFs {
  private static final Log LOG = LogFactory.getLog(TestAdlsMigratorViewFs.class);
  ...
  public static void setup() throws URISyntaxException{
    try {
      ...
      root = new Path("target/TestAdlsMigratorViewFs").makeQualified(fs.getUri(),
