...
public class TestOptionsParser {
  ...
  public void testParseIgnoreFailure() {
    AdlsMigratorOptions options = OptionsParser.parse(new String[] {
  ...
  public void testParsebandwidth() {
    AdlsMigratorOptions options = OptionsParser.parse(new String[] {
        "hdfs://localhost:8020/source/first",
        "hdfs://localhost:8020/target/"});
    Assert.assertEquals(options.getMapBandwidth(), AdlsMigratorConstants.DEFAULT_BANDWIDTH_MB);
  ...
  public void testParseMaps() {
    AdlsMigratorOptions options = OptionsParser.parse(new String[] {
        "hdfs://localhost:8020/source/first",
        "hdfs://localhost:8020/target/"});
    Assert.assertEquals(options.getMaxMaps(), AdlsMigratorConstants.DEFAULT_MAPS);
  ...
  public void testParseNumListstatusThreads() {
    ...
    options = OptionsParser.parse(new String[] {
        ...
        "hdfs://localhost:8020/source/first",
        "hdfs://localhost:8020/target/"});
    Assert.assertEquals(AdlsMigratorOptions.maxNumListstatusThreads,
  ...
  public void testToString() {
    ...
    String val = "AdlsMigratorOptions{atomicCommit=false, syncFolder=false, "
  ...
  public void testCopyStrategy() {
    ...
    options = OptionsParser.parse(new String[] {
        ...
        "hdfs://localhost:8020/source/first",
        "hdfs://localhost:8020/target/"});
    Assert.assertEquals(options.getCopyStrategy(), AdlsMigratorConstants.UNIFORMSIZE);
  }
  ...
  public void testPreserve() {
    ...
    Assert.assertEquals(i, AdlsMigratorOptionSwitch.PRESERVE_STATUS_DEFAULT.length() - 2);
  ...
  public void testOptionsSwitchAddToConf() {
    ...
    Assert.assertNull(conf.get(AdlsMigratorOptionSwitch.ATOMIC_COMMIT.getConfigLabel()));
    AdlsMigratorOptionSwitch.addToConf(conf, AdlsMigratorOptionSwitch.ATOMIC_COMMIT);
    Assert.assertTrue(conf.getBoolean(AdlsMigratorOptionSwitch.ATOMIC_COMMIT.getConfigLabel(), false));
  }

  @Test
  public void testOptionsAppendToConf() {
    Configuration conf = new Configuration();
    Assert.assertFalse(conf.getBoolean(AdlsMigratorOptionSwitch.IGNORE_FAILURES.getConfigLabel(), false));
    Assert.assertFalse(conf.getBoolean(AdlsMigratorOptionSwitch.ATOMIC_COMMIT.getConfigLabel(), false));
    AdlsMigratorOptions options = OptionsParser.parse(new String[] {
        "-atomic",
        "-i",
        "hdfs://localhost:8020/source/first",
    ...
    Assert.assertTrue(conf.getBoolean(AdlsMigratorOptionSwitch.IGNORE_FAILURES.getConfigLabel(), false));
    Assert.assertTrue(conf.getBoolean(AdlsMigratorOptionSwitch.ATOMIC_COMMIT.getConfigLabel(), false));
    Assert.assertEquals(conf.getInt(AdlsMigratorOptionSwitch.BANDWIDTH.getConfigLabel(), -1),
        AdlsMigratorConstants.DEFAULT_BANDWIDTH_MB);

    conf = new Configuration();
    Assert.assertFalse(conf.getBoolean(AdlsMigratorOptionSwitch.SYNC_FOLDERS.getConfigLabel(), false));
    Assert.assertFalse(conf.getBoolean(AdlsMigratorOptionSwitch.DELETE_MISSING.getConfigLabel(), false));
    Assert.assertEquals(conf.get(AdlsMigratorOptionSwitch.PRESERVE_STATUS.getConfigLabel()), null);
    options = OptionsParser.parse(new String[] {
        "-update",
        "-delete",
        "-pu",
        ...
        "hdfs://localhost:8020/target/"});
    options.appendToConf(conf);
    Assert.assertTrue(conf.getBoolean(AdlsMigratorOptionSwitch.SYNC_FOLDERS.getConfigLabel(), false));
    Assert.assertTrue(conf.getBoolean(AdlsMigratorOptionSwitch.DELETE_MISSING.getConfigLabel(), false));
    Assert.assertEquals(conf.get(AdlsMigratorOptionSwitch.PRESERVE_STATUS.getConfigLabel()), "U");
    Assert.assertEquals(conf.getInt(AdlsMigratorOptionSwitch.BANDWIDTH.getConfigLabel(), -1), 11);
  }
  ...
  public void testAppendOption() {
    ...
    Assert.assertFalse(conf.getBoolean(
        AdlsMigratorOptionSwitch.APPEND.getConfigLabel(), false));
    Assert.assertFalse(conf.getBoolean(
        AdlsMigratorOptionSwitch.SYNC_FOLDERS.getConfigLabel(), false));

    AdlsMigratorOptions options = OptionsParser.parse(new String[] { "-update",
  ...
  private void testSnapshotDiffOption(boolean isDiff) {
    ...
    final String optionLabel = isDiff?
        AdlsMigratorOptionSwitch.DIFF.getConfigLabel() :
          AdlsMigratorOptionSwitch.RDIFF.getConfigLabel();
    Configuration conf = new Configuration();
  ...
  public void testVerboseLog() {
    AdlsMigratorOptions options = OptionsParser
