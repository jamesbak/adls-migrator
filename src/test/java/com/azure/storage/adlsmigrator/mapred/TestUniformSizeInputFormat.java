...
public class TestUniformSizeInputFormat {
  ...
  private static AdlsMigratorOptions getOptions(int nMaps) throws Exception {
    ...
    final AdlsMigratorOptions AdlsMigratorOptions = new AdlsMigratorOptions(sourceList, targetPath);
    AdlsMigratorOptions.setMaxMaps(nMaps);
  ...
  public void testGetSplits(int nMaps) throws Exception {
    AdlsMigratorOptions options = getOptions(nMaps);
