...
public class TestDynamicInputFormat {
  ...
  private static AdlsMigratorOptions getOptions() throws Exception {
    ...
    AdlsMigratorOptions options = new AdlsMigratorOptions(sourceList, targetPath);
  ...
  public void testGetSplits() throws Exception {
    AdlsMigratorOptions options = getOptions();
    Configuration configuration = new Configuration();
  ...
  public void testGetSplitRatio() throws Exception {
    ...
    conf.setInt(AdlsMigratorConstants.CONF_LABEL_MAX_CHUNKS_TOLERABLE, -1);
    conf.setInt(AdlsMigratorConstants.CONF_LABEL_MAX_CHUNKS_IDEAL, -1);
    conf.setInt(AdlsMigratorConstants.CONF_LABEL_MIN_RECORDS_PER_CHUNK, -1);
    conf.setInt(AdlsMigratorConstants.CONF_LABEL_SPLIT_RATIO, -1);
    ...
    conf.setInt(AdlsMigratorConstants.CONF_LABEL_MAX_CHUNKS_TOLERABLE, 100);
    conf.setInt(AdlsMigratorConstants.CONF_LABEL_MAX_CHUNKS_IDEAL, 30);
    conf.setInt(AdlsMigratorConstants.CONF_LABEL_MIN_RECORDS_PER_CHUNK, 10);
    conf.setInt(AdlsMigratorConstants.CONF_LABEL_SPLIT_RATIO, 53);
  ...
  public void testDynamicInputChunkContext() throws IOException {
    Configuration configuration = new Configuration();
    configuration.set(AdlsMigratorConstants.CONF_LABEL_LISTING_FILE_PATH,
        "/tmp/test/file1.seq");
