...
/**
 * test methods run end execute of AdlsMigrator class. silple copy file
 * @throws Exception 
 */
  @Test
  ...
  /**
   * test main method of AdlsMigrator. Method should to call System.exit().
   * 
   */
  @Test
