 ...
 * to create the copy-listing for AdlsMigrator,
...
public class FileBasedCopyListing extends CopyListing {
   ...
   */
  @Override
  public void doBuildListing(Path pathToListFile, AdlsMigratorOptions options) throws IOException {
    AdlsMigratorOptions newOption = new AdlsMigratorOptions(options);
