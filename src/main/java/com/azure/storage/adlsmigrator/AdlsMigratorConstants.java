...
public class AdlsMigratorConstants {
   ...
   */
  public static final String CONF_LABEL_ATOMIC_COPY = "adlsmigrator.atomic.copy";
  public static final String CONF_LABEL_WORK_PATH = "adlsmigrator.work.path";
  ...
  public static final String CONF_LABEL_DELETE_MISSING = "adlsmigrator.delete.missing.source";
  ...
  public static final String CONF_LABEL_COPY_STRATEGY = "adlsmigrator.copy.strategy";
  ...
  public static final String CONF_LABEL_RDIFF = "adlsmigrator.copy.rdiff";
   ...
   */
  public static final String CONF_LABEL_TARGET_WORK_PATH = "adlsmigrator.target.work.path";
  ...
  /** AdlsMigrator Blocks Per Chunk: {@value}. */
  public static final String CONF_LABEL_BLOCKS_PER_CHUNK =
      "adlsmigrator.blocks.per.chunk";
